...
maxInt (Leaf i)     = i
maxInt (Node l a r) =
                      if maxInt a > maxInt r && maxInt a > l
                          then maxInt a
                          else if maxInt r > maxInt a && maxInt r > l
                               then maxInt r
                               else l
...
minInt (Leaf i)     = i
minInt (Node l a r) =
                      if minInt a < minInt r && minInt a < l
							then minInt a
                          else if minInt r < minInt a && minInt r < l
                               then minInt r
                               else l
...
sumInts :: Tree -> Int
sumInts (Leaf i)   = i
sumInts (Node l a r) = l + sumInts a + sumInts r
...
preorder :: Tree -> [Int]
preorder (Leaf i)     = [i]
preorder (Node l a r) = [l] ++ preorder a ++ preorder r
...
isBST :: Tree -> Bool
isBST (Leaf i) = True
isBST (Node l a r) = if (l >  (val a )) && (l < (val r)) 
						then True 
						else False
